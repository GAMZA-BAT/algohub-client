import { SolvedStatusTableProvider } from "@/view/group/dashboard/SolvedStatusSection/SolvedStatusTable/provider";
import { SolutionsCurrentStatusResponse } from "@/app/api/type";
import { titleStyle } from "@/app/group/[groupId]/page.css";
import SolvedStatusTable from "@/view/group/dashboard/SolvedStatusSection/SolvedStatusTable";
