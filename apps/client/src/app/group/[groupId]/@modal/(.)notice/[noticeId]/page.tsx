...
import NoticeDetail from "@/app/group/[groupId]/@modal/(.)notice/components/NoticeModal/NoticeDetail";
import {
  noticeHeaderStyle,
  noticeModalWrapper,
...
const InterceptingNoticeDetailPage = ({
...
export default InterceptingNoticeDetailPage;
